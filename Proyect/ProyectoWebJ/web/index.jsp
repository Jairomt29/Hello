...
<html>
    ...
    <body>
        <header>
            <h1 class="titulo">Jairo Mergildo <span>Freelancer</span></h1>
        </header>
        <div class="nav-bg">
        ...
        <main class="contenedor sombra">
            <h2>Mis servicios</h2>
            <div class="servicios"> <!<!-- Inicia servicios -->
                ...
                <section class="servicio">
                    ...
                    <div class="iconos">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-apple-filled" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffec00" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
            ...
            </div> <!<!-- Cierra servicios-->

            <section>
                <h2>Contacto</h2>
                <form class="formulario">
                    <fieldset>
                        <legend>Contacto de llenado de todos los campos</legend>
                        <div class="contenedor__campos">
                            <div class="campo">
                                <label>Nombre</label>
                                <input class="input__text" type="text" placeholder="Ingresa tu nombre"> 
                            </div>
                            <div class="campo">
                                <label>Telefono</label>
                                <input class="input__text" type="tel" placeholder="Ingresa tu telefono">
                            </div>
                            <div class="campo">
                                <label>Correo</label>
                                <input class="input__text" type="email" placeholder="Ingresa tu correo">
                            </div>
                            <div class="campo">
                                <label>Mensaje</label>
        ...
        <footer class="footer">
            <p>Todos los derechos son reservados, © Jairo Mergildo Trinidad Freelancer</p>
        </footer>
    </body>
</html>
